...
public class ItemMapper {
	...
	public static Item toModel(ItemCreateDto dto) {
		Item item = Item.builder().id(null).name(dto.getName()).available(dto.getAvailable())
	...
	public static ItemFullDto toDto(Item item) {
		ItemFullDto dto = ItemFullDto.builder().id(item.getId()).name(item.getName()).available(item.getAvailable())
