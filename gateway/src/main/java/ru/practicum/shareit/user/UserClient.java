...
public class UserClient extends BaseClient {
	...
	public ResponseEntity<Object> createUser(final UserRequestDto userDto) {
		return post("", userDto);
	}

	public ResponseEntity<Object> updateUser(final Long userId, final UserRequestDto userDto) {
